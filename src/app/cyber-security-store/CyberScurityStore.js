...
import { COOKIE_TEMPLATE, CYBER_SECURITY_STORE } from "../services/Url";
...
const CyberScurityStore = () => {
  ...
  const { data:data1, isLoading: isLoading1  } = useCustomGet(CYBER_SECURITY_STORE);
  ...
  return (
    <>
      ...
      <div className="internal-service-page" id="record-mang-service">
        ...
        <DownloadCourse  link={'/checkout/31333'}/>  
...
export default CyberScurityStore;
