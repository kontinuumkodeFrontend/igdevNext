...
import { CLINICAL_SAFETY_OFFICER_HANDBOOK } from "../services/Url";
import { useCustomGet } from "../services/Service";
import FAQDynamic from "../Components/FAQDynamic";
import DownloadFormDisclamer from "../Components/DownloadFormDisclamer";
import { downloadFormDatCLINICAL } from "../services/Store";
import Link from "next/link";


const ClincalSafetyOfficerHandbook = () => {
    const authenticity = "/images/authenticity.png";
    const priceIcon = "/images/Toolkits/image3.png";
          ...
          <Container>
              ...
              <div className="complex-chng-des chng-des-md reverse">
                ...
                <div className="cmpx-img-card mt-0 long_img img_design">
                  <Link href={"/product-detail/31112"}>
        ...
        >
          <Container>
            ...
            <div className="d-flex justify-content-center mt-5">
              <DownloadFormDisclamer name={"Buy Now"} data={downloadFormDatCLINICAL}  id={'31112'}/>
            </div>
          </Container>
        </section>
...
export default ClincalSafetyOfficerHandbook;
