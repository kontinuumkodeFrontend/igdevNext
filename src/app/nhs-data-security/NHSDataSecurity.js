...
import { downloadFormDatNHS } from "../services/Store";
import Link from "next/link";

const NHSDataSecurity = () => {
    const authenticity =  "/images/authenticity.png";
const priceIcon =  "/images/Toolkits/image1.png";
const bannerBG =  "/images/patternEbook.png";
const bannerImage =  "/images/NHSToolkit.png";
const product =  "/images/product.png";
  ...
  var bannerContent = {
    heading: 'NHS Data Security & Protection Compliance',
    smallHeading: 'Achieve Unparalleled NHS Data Security & Protection Compliance with Our Toolkit',
    description: 'Your All-in-One Resource for Ensuring Data Security & Compliance in Healthcare',
    image:bannerImage,
    backgroundImage: bannerBG,
    btnLink: '/product-detail/31114' ,
    price: '£1495'
  };
      ...
      <div className="internal-service-page" id="record-mang-service">
        ...
        <section className="wht_isid_sec sec-padding-top">
          <Container>
              ...
              <div className="complex-chng-des chng-des-md reverse">
                ...
                <Link href={"/product-detail/31114"}>
        ...
        >
          <Container>
            ...
            <div className="row ">
              <div className="col-xl-4  col-md-6 col-sm-12 col-12">
                <div className="security-content mb-xl-0 mb-3">
                  <img  loading="lazy"  width="" height=""   src={authenticity} alt="authenticity1img" />
            ...
            <DownloadFormDisclamer name={"Buy Now"} data={downloadFormDatNHS} id={'31114'}/>
            </div>
          </Container>
        </section>
...
export default NHSDataSecurity;
