...
export default function GdprComplianceToolkit() {
              ...
              <div className="complex-chng-des chng-des-md reverse">
                ...
                <Link href={"/product-detail/31113"}>
                  <img  loading="lazy"  width="" height=""  
                    src={'/images/Toolkits/image4.png'}
                    alt="img"
                  />
                  </Link>
                </div>
            ...
            <div className="row ">
              <div className="col-xl-4  col-md-6 col-sm-12 col-12">
                <div className="security-content mb-xl-0 mb-3">
                  <img  loading="lazy"  width="" height=""   src="/images/authenticity.png" alt="img" />
        ...
        >
          <Container>
            ...
            <div className="row ">
              <div className="col-xl-4  col-md-6 col-sm-12 col-12">
                <div className="security-content mb-xl-0 mb-3">
                  <img  loading="lazy"  width="" height=""   src="/images/product.png" alt="img" />
                  <h5 className="my-lg-3 my-md-3 my-sm-3 my-1 fw-bold">
