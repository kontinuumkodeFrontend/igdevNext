...
import { CLINICAL_SAFETY_OFFICER_HANDBOOK, GDPR_COMPLIANCE_TOOLKIT } from "../../services/Url";
import { useCustomGet } from "../../services/Service";
import FAQDynamic from "../../Components/FAQDynamic";
import DownloadFormDisclamer from "../../Components/DownloadFormDisclamer";
import { downloadFormDatGDPR } from "../../services/Store";
import Link from "next/link";

const GdprComplianceToolkit = () => {
    const authenticity =  "/images/authenticity.png";
    const priceIcon =  "/images/Toolkits/image4.png";
    const product =  "/images/product.png";

  const { data, isLoading } = useCustomGet(CLINICAL_SAFETY_OFFICER_HANDBOOK);
  const { data:data1, isLoading: isLoading1 } = useCustomGet(GDPR_COMPLIANCE_TOOLKIT);
      ...
      <div className="internal-service-page" id="record-mang-service">
        ...
        <section className="wht_isid_sec sec-padding-top">
          <Container>
              ...
              <div className="complex-chng-des chng-des-md reverse">
                ...
                <Link href={"/product-detail/31113"}>
        ...
        >
          <Container>
            ...
            <div className="row ">
              <div className="col-xl-4  col-md-6 col-sm-12 col-12">
                <div className="security-content mb-xl-0 mb-3">
                  <img  loading="lazy"  width="" height=""   src={authenticity} alt="img" />
            ...
            <DownloadFormDisclamer name={"Buy Now"} data={downloadFormDatGDPR}  id={'31113'}/>
            </div>
          </Container>
        </section>
        ...
        >
          <Container>
            ...
            <div className="row ">
              <div className="col-xl-4  col-md-6 col-sm-12 col-12">
                <div className="security-content mb-xl-0 mb-3">
                  <img  loading="lazy"  width="" height=""   src={product} alt="img" />
                  <h5 className="my-lg-3 my-md-3 my-sm-3 my-1 fw-bold">
...
export default GdprComplianceToolkit;
