...
import { COOKIE_TEMPLATE, DATA_PRIVACY_STORE } from "../services/Url";
...
const phonecall = "/images/phone-call.png";
  ...
  } = useCustomGet(DATA_PRIVACY_STORE);
  ...
  return (
    <>
      ...
      <div className="internal-service-page" id="record-mang-service">
        ...
        <DownloadCourse  link={'/checkout/31335'}/>  
